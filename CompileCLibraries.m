...
%                   found first.
%
%The file has been successfully run on Windows 11 using MinGW64 8.1 and
...
%Compile divRectOpt
mex('-v','CFLAGS="$CFLAGS -std=c11 -Wall"','COMPFLAGS="$COMPFLAGS /std:c11 -Wall"','-R2018a','-outdir','./0_Compiled_Code/',...
...
mex('-v','CFLAGS="$CFLAGS -frounding-math -std=c11 -Wall"','COMPFLAGS="$COMPFLAGS /std:c11 -Wall"','-R2018a','-outdir','./0_Compiled_Code/',...
...
mex('-v','-R2018a','CXXFLAGS="$CXXFLAGS -std=c++17 -Wall"','COMPFLAGS="$COMPFLAGS /std:c++17 -Wall"','-outdir','./0_Compiled_Code/','-I./',...
    './Misc/nDim2Index.cpp');
%Compile getCompressedIdxMappings
mex('-v','-R2018a','CXXFLAGS="$CXXFLAGS -std=c++17 -Wall"','COMPFLAGS="$COMPFLAGS /std:c++17 -Wall"','-outdir','./0_Compiled_Code/','-I./',...
    './Misc/getCompressedIdxMappings.cpp');
...
mex('-v','CFLAGS="$CFLAGS -std=c11 -Wall"','COMPFLAGS="$COMPFLAGS /std:c11 -Wall"','-R2018a','-outdir','./0_Compiled_Code/','-I./',...
...
%Compile exactPairSum
mex('-v','-R2018a','CXXFLAGS="$CXXFLAGS -std=c++17 -Wall"','COMPFLAGS="$COMPFLAGS /std:c++17 -Wall"','-outdir','./0_Compiled_Code/','-I./',...
    './Mathematical_Functions/Accurate_Arithmetic/exactPairSum.cpp');
...
mex('-v','CXXFLAGS="$CXXFLAGS -std=c++17 -Wall"','COMPFLAGS="$COMPFLAGS /std:c++17 -Wall"','-R2018a','-outdir','./0_Compiled_Code/','-I./',...
...
mex('-v','-R2018a','CXXFLAGS="$CXXFLAGS -std=c++17 -Wall"','COMPFLAGS="$COMPFLAGS /std:c++17 -Wall"','-outdir','./0_Compiled_Code/','-I./',...
    '-I./Mathematical_Functions/Combinatorics/Shared_C++_Code/',...
    './Mathematical_Functions/Combinatorics/Binomial_Multinomial/binomial.cpp',...
...
mex('-v','CXXFLAGS="$CXXFLAGS -std=c++17 -Wall -DEIGEN_MPL2_ONLY"','COMPFLAGS="$COMPFLAGS /std:c++17 -Wall -DEIGEN_MPL2_ONLY"','-R2018a','-outdir','./0_Compiled_Code/','-I./',...
...
%Compile tria
mex('-v','CFLAGS="$CFLAGS -std=c11 -Wall"','COMPFLAGS="$COMPFLAGS /std:c11 -Wall"','-R2018a','-outdir','./0_Compiled_Code/',lapackInclude,'-I./',...
...
%Compile assign3D
mex('-v','CFLAGS="$CFLAGS -std=c11 -Wall"','COMPFLAGS="$COMPFLAGS /std:c11 -Wall"','-R2018a','-outdir','./0_Compiled_Code/',blasInclude,'-I./',...
    '-I./Assignment_Algorithms/2D_Assignment/Shared_C_Code/',...
...
%Compile assign3DBB
mex('-v',blasLib,'CXXFLAGS="$CXXFLAGS -std=c++17 -Wall"','COMPFLAGS="$COMPFLAGS /std:c++17 -Wall"','-R2018a','-outdir','./0_Compiled_Code/',blasInclude,'-I./',...
    '-I./Mathematical_Functions/Shared_C_Code/',...
    '-I./Assignment_Algorithms/2D_Assignment/Shared_C_Code/',...
    '-I./Assignment_Algorithms/3D_Assignment/Shared_C_Code/',...    
...
%Compile changeEpoch
mex('-v','CFLAGS="$CFLAGS -std=c11"','COMPFLAGS="$COMPFLAGS /std:c11 -Wall"','-R2018a','-outdir','./0_Compiled_Code/',...
    '-I./3rd_Party_Libraries/sofa/src/',...
    '-I./',...
    './Astronomical_Code/changeEpoch.c',linkCommands{:})
%Compile starCat2Obs
mex('-v','-R2018a','CXXFLAGS="$CXXFLAGS -std=c++17 -Wall"','COMPFLAGS="$COMPFLAGS /std:c++17 -Wall"','-outdir','./0_Compiled_Code/',...
    '-I./3rd_Party_Libraries/sofa/src/',...
    '-I./Coordinate_Systems/Shared_C++_Code/',...
    '-I./',...
...
mex('-v','CXXFLAGS="$CXXFLAGS -std=c++17 -Wall"','COMPFLAGS="$COMPFLAGS /std:c++17 -Wall"','-R2018a','-outdir','./0_Compiled_Code/',...
...
elseif(ispc())%Windows    
    compPath=getenv('COMPILER');
    [~,compName]=fileparts(compPath);
    cc=[compPath,' ',getenv('COMPFLAGS'),' -std=c++17',' '];
    ll=getenv('LINKER');
...
mex('-v','CXXFLAGS="$CXXFLAGS -std=c++17 -Wall"','-R2018a','COMPFLAGS="$COMPFLAGS /std:c++17 -Wall"','-outdir','./0_Compiled_Code/',...
