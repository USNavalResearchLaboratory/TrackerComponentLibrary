function [zCart,RCart]=ruv2CartStdRefracCubature(zRUVBiased,SR,useHalfRange,zTx,zRx,M,Ns,xi,w,ce,ellipsOpts,xMax)
...
%        SR The 3X3XnumMeas lower-triangular square roots of the
%           measurement covariance matrices for the measurements. If
...
for curMeas=1:numMeas
    ...
    cubPoints=ruv2CartStdRefrac(cubPoints,useHalfRange,zTx,zRx,M,Ns,ce,ellipsOpts,xMax);
