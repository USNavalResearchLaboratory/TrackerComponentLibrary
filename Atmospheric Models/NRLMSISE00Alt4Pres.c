 ...
 *                latLon WGS-84 latitude and longitude of the point where
 ...
 *
 *OUTPUTS:  altitude    The approximate ellipsoidal altitude associated
 *                      with the pressure given on the input in meters.
 *          gasTable    A cell array of constituent elements of the
 *                      atmosphere and their number densities.
 *                      gasTable{i,1} is a string listing the name of the 
 *                      ith constituent element of the atmosphere. This can
 *                      take the values
 *                      'He' Helium
 *                      'O'  Elemental Oxygen
 *                      'N2' Nitrogen
 ...
 *                      'O*' Anomalous Oxygen
 *                      gasTable{i,2} is the corresponding number density
 *                      of the ith constituent element in units of atoms
 *                      per cubic meter.
 ...
 *                      kilograms per cubic meter. Note that d(6) is
 *                      computed using a definition of the atomic mass unit
 *                      and definitions of the atomic masses that are not
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    latLon=(double*)mxGetData(prhs[3]);
    ...
    if(nlhs>3&&!mxIsEmpty(prhs[4])) {
        ...
        if(mxGetM(prhs[4])==1&&mxGetM(prhs[4])==1) {
            ...
            double *aVec=(double*)mxGetData(prhs[4]);
            for(i=0;i<7;i++) {
