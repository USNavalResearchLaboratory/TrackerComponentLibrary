 ...
 **/
     ...
     */
    ptrdiff_t * restrict col4row=(ptrdiff_t*)tempBuffer;
    tempBuffer=(void*)((ptrdiff_t*)tempBuffer+numRow);
    
    ptrdiff_t * restrict row4col=(ptrdiff_t *)tempBuffer;
    tempBuffer=(void*)((ptrdiff_t*)tempBuffer+numCol);
    
    //This holds the INDICES of the scanned columns.
    size_t * restrict ScannedColIdx=(size_t*)(tempBuffer);
    tempBuffer=(void*)((size_t*)tempBuffer+numCol);
    
    size_t * restrict pred=(size_t*)tempBuffer;
    tempBuffer=(void*)((size_t*)tempBuffer+numRow);
    
    size_t * restrict Row2Scan=(size_t*)tempBuffer;
    tempBuffer=(void*)((size_t*)tempBuffer+numRow);
    
    double * restrict shortestPathCost=(double*)(tempBuffer);
    tempBuffer=(void*)((double*)tempBuffer+numRow);
    
    //This holds 1's and 0's for which rows were scanned.
    bool * restrict ScannedRows=(bool*)(tempBuffer);
