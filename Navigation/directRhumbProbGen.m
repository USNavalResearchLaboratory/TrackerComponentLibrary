...
%for a non-zero altitude is based on [1]. The function is significantly
%faster if a zero altitude is used.
%
...
%
%Note that the function is significantly faster if height=0 or
