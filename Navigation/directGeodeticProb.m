...
for curPoint=1:N
    ...
    phi1=latLonStart(1,curPoint);
    s12=distVal(curPoint);
    alpha1=azStart(curPoint);
    ...
    %sinBeta1 and cosBeta1 are here a not-normalized vector for the sine and
    %cosine.
...
%           series has been extended to the tenth order.
%
%REFERENCES:
%[1] C. F. F. Karney, "Algorithms for geodesics," Journal of Geodesy, vol.
%    87, no. 1, pp. 43-55, Jan. 2013.
