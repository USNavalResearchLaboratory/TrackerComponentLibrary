...
%compile_direct commented out by David F. Crouse for inclusion in the
%Tracker Component Library, June 2016.
...
%Component Library, June 2016. Some older versions of Matlab and do not
%register the new mex files until the script ends, meaning that the test
%run would  fail even though the compile is a success.
% %%
% clear data cones
% disp('Example run:');
% randn('seed',9)
...
% %scs_direct commented out by David F. Crouse for inclusion in the Tracker
% %Component Library, June 2016.
