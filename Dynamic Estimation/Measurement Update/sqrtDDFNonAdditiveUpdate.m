...
%                        This can either be of the form h(xStacked),
%                        where xStacked is [x;w], where x is the state and
%                        w is the measurement noise value, or this can be
%                        of the form h(x,w), where the inputs are 
