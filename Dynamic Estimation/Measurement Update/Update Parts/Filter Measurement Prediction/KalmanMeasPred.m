...
%           is KalmanUpdate.
%
%INPUTS: xPred The xDim X 1 predicted target state. If one only wants
...
%              as z=H*x+noise.
%
%OUTPUTS: zPred The zDimX1 measurement prediction from the filter or an
%               empty matrix is xPred was an empty matrix.
