...
%           weak stochastic It�-Taylor expansion, possibly taking more than
...
%generalization to many different It�-taylor expansions given in [1].
...
%    Oct. 2010.
%[3] D. F. Crouse, "It�-Taylor expansion moments for continuous-time state
