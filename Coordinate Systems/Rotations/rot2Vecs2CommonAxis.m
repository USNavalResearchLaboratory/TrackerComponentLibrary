function [vec1Rot,vec2Rot,R]=rot2Vecs2CommonAxis(vec1,vec2,zeroAxis,getAllRots)
%%ROT2VECS2COMMONAXIS Given two 3D vectors, vec1 and vec2, rotate the
%           vectors such that they fall on a common axis. That is, rotate
...
% vec1=[-7.8;6.7;-6.9];
% vec2=[-0.1;0.1;-11.9];
% [vec1Rot,vec2Rot,R]=rot2Vecs2CommonAxis(vec1,vec2);
% 
% vec1Rot(3)
% vec2Rot(3)
