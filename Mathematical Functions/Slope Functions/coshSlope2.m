function y=coshSlope2(x)
%%COSHSLOPE2 Evaluate the function 2*(cosh(x)-1)/x^2 avoiding problems at
...
%          be evaluated.
%
%OUTPUTS: y The value(s) of the function 2*(cosh(x)-1)/x^2 at the point(s)
%           in x.
%
...
x1=x(~sel);
y(~sel)=1+x1.^2.*(1/12+x1.^2.*(1/360+x1.^2/20160));
