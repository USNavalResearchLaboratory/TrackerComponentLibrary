...
%               cost function. In the unwieghted case, the fast algorithm
%               of [1] is used. In the weighted case, the 
%
...
%           1 the maximum number of iteratiosn elapsed.
%
...
% %The algorithm qucikly converges.
%
%EXAMPLE 2:
