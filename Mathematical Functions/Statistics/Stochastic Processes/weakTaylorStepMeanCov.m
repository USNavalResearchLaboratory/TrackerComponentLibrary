...
%           single step of a weak Itô-Taylor expansion of a stochastic
...
% algorithm A parameter specifying the type of explicit weak Itô-Taylor
...
%involving the products of Itô stochastic integrals and the products of the
%Wiener process and an Itô stochastic integral. This includes Equation
%2.160 in Chapter 5.2 of [1] for the product of the Wiener process and the
%Itô stochastic integral, Lemma 5.7.1 for the expected value of such
...
%evaluate I_{0,0} when necessary.
%
