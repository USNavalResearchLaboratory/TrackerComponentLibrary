function rMean=meanRad4Ellipsoid(a,f)
%%MEANRAD4ELLIPSOID Given an ellipsoid of rotation, determine the
%               mean radius of the ellipsoid. This can be useful for
...
%
%OUTPUTS: rMean The mean radius for the specified 3D ellipsoid.
%
%The formula for the mean radius of an ellipsoid is given in [1].
%
%REFERENCES:
