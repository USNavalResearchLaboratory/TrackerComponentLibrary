function theRank=rankComposition(p,firstElMostSig)
%%RANKCOMPOSITION Obtain the lexicographic order (the rank) of a particular
%                 composition starting at 0. A composition of n into t
%                 is a way of putting n unlabeled balls into t labeled
%                 slots. Compositions are tuples of n integers >0 that
