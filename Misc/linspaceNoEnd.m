function vals=linspaceNoEnd(minVal,maxVal,numPoints)
%LINSPACENOEND Generate numPoints values uniformly spaced starting at
%              minVal going up to but not including maxVal. The distance
%              from the last point in vals to maxVal equals the spacing
%              between all other points (plus finite precision errors).
%
