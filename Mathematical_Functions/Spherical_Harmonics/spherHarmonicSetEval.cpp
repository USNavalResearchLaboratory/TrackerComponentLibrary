...
void mexFunction(const int nlhs, mxArray *plhs[], const int nrhs, const mxArray *prhs[]) {
    ...
    if(useComplexAlg) {
        ...
        CountingClusterSetVecCPP<complex<double>> C;
        CountingClusterSetVecCPP<complex<double>> S;
        ...
        spherHarmonicSetEvalCPPComplex(V, gradV, HessianV, C, S, point, numPoints, a, c, systemType, spherDerivs,scalFactor,algorithm);
    } else {//All data is real.
        double *V;
        double *gradV=NULL;
        double *HessianV=NULL;
        CountingClusterSetVecCPP<double> C;
        CountingClusterSetVecCPP<double> S;
        ...
        spherHarmonicSetEvalCPPReal(V,gradV,HessianV,C,S,point,numPoints,real(a),real(c),systemType, spherDerivs,scalFactor,algorithm);
    }
