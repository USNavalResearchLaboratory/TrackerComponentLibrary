function [xi,w]=secondOrderTetrahedronCubPoints()
%%SECONDORDERTETRAHEDRONCUBPOINTS Obtain second-order cubature points
...
%precision limits.
% [xi,w]=secondOrderTetrahedronCubPoints();
% alpha=[1;1;0];
...
M=[-0.72360679774997896964091736687312762354,  -0.72360679774997896964091736687312762354,   0.17082039324993690892275210061938287063,   0.33333333333333333333333333333333333333;
