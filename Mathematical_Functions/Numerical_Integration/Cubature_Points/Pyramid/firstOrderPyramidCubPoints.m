function [xi,w]=firstOrderPyramidCubPoints()
%%FIRSTORDERPYRAMIDCUBPOINTS Generate first-order cubature points for
...
%
%This function implements the points given in [1] (1 point). This is just
%the point [0;0;-0.5] with a weight of 8/3
%
%REFERENCES:
