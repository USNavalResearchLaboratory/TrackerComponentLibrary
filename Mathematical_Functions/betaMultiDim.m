function betaVal=betaMultiDim(a,b,p)
%%BETAMULTIDIM Evaluate the multivariate beta function. This is defined
%           on page 20 of [1] as the integral
...
%
%OUTPUTS: betaVal The multivariate beta function values.  The
%                 dimensionality of this is consistent with that of a and b
%                 (whichever is a matrix).
%
%This function just takes the exponential of betalnMultiDim.
%
%REFERENCES:
...
betaVal=exp(betalnMultiDim(a,b,p));
