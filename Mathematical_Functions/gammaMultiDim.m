function gammaVal=gammaMultiDim(a,p)
%%GAMMAMULTIDIM Evaluate the multivariate gamma function for a positive
%           real argument. The multivariate gamma function is defined as an
%           integral starting on page 18 in [1] as
...
%
%OUTPUTS: gammaVal The positive, scalar multivariate gamma function values.
%                  The dimensionality of this is the same as that of a.
%
%REFERENCES:
...
piCoeff=1;
for k=2:p
    piCoeff=piCoeff*sqrtPi;
    gammaVal=piCoeff*gammaVal.*gamma(a+(1-k)/2);
end
end
