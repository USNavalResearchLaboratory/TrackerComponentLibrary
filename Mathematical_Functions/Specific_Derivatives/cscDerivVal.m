function val=cscDerivVal(z,n)
%%CSCDERIVVAL Return the value of the nth derivative of csc(x) with respect
%             to x evaluated at x=z.
%
%INPUTS: z A matrix of real or complex values at which the nth derivative
%          of the cosecant function is desired.
%        n The number of derivatives to take. n>=0.
%
%OUTPUTS: val The value of the nth derivative of the cosecant function
...
%aplicability to the cosecant function.
%
%REFERENCES:
