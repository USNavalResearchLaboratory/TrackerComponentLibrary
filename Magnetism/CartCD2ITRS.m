...
%             CD coordinates are useful when studying the ionosphere. Note
%             that most papers use CD coordinates in spherical form, not
%             Cartesian form.
%
...
%                  'IGRF' or 'WMM' to specify which magnetic field model
...
%
%OUTPUTS: zITRS The points in zCartCD rotated into ITRS. The ITRS and the
%               CD coordinate systems are related by a rotation.
%        rotMat The 3X3 rotation matrix such that
%               zITRS(:,i)=rotMat*zCartCD(:,i).
%
...
%longitude in CD coordinates. We take the transpose of the matrix to
